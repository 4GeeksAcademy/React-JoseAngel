...
// 📝 CORREGIDO: Nombre en singular (solo hay un Jumbotron)
const Jumbotron = () => {
    return (
        // 📝 FORMATEADO: Todo el HTML estaba en una sola línea (ilegible)
        // Ahora cada elemento tiene su propia línea con indentación correcta
